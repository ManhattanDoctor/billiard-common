...
export const USER_PREFERENCES_NICKNAME_MIN_LENGTH = 5;
export const USER_PREFERENCES_NICKNAME_MAX_LENGTH = 32;
export const USER_PREFERENCES_NICKNAME_REGEXP = new RegExp(`^[A-Za-z0-9_.-]{${USER_PREFERENCES_NICKNAME_MIN_LENGTH},${USER_PREFERENCES_NICKNAME_MAX_LENGTH}}$`)
